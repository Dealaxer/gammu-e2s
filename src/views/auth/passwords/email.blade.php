...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="{{ app()->getLocale() }}"> <!--<![endif]-->
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                        <div class="push-30-t push-50 animated fadeIn">
                            ...
                            <form class="js-validation-login form-horizontal push-30-t" action="{{ route('password.email') }}" method="post">
							{{ csrf_field() }}
                                ...
                                <div class="form-group push-30-t">
                                    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-3">
                                        <button class="btn btn-sm btn-success" type="submit">Send Password Reset Link</button>
                                    </div>
                                </div>
                            </form>
        ...
        <script src="{{ asset('assets/js/resetp.js') }}"></script>
    </body>
</html>