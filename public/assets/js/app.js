...
var App = function() {
	...
	$('#phpinfo-pg style').remove();
	var new_style_phpi = "<style>#phpinfo-pg pre{margin:0;font-family:monospace}#phpinfo-pg table{border-collapse:collapse;border:0;width:934px;box-shadow:1px 2px 3px #ccc}#phpinfo-pg .center{text-align:center}#phpinfo-pg .center table{margin:1em auto;text-align:left}#phpinfo-pg .center th{text-align:center !important}#phpinfo-pg td,#phpinfo-pg th{border:1px solid #666;font-size:75%;vertical-align:baseline;padding:4px 5px}#phpinfo-pg h1{font-size:150%}#phpinfo-pg h2{font-size:125%}#phpinfo-pg .p{text-align:left}#phpinfo-pg .e{background-color:#ccf;width:300px;font-weight:bold}#phpinfo-pg .h{background-color:#99c;font-weight:bold}#phpinfo-pg .v{background-color:#ddd;max-width:300px;overflow-x:auto;word-wrap:break-word}#phpinfo-pg .v i{color:#999}#phpinfo-pg img{float:right;border:0}#phpinfo-pg hr{width:934px;background-color:#ccc;border:0;height:1px}</style>";
	$('#phpinfo-pg').prepend(new_style_phpi);
